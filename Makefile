...
ACLOCAL = ${SHELL} /home/laurynas/tmp/libxml/libxml2-2.7.3/missing --run aclocal-1.10
AMTAR = ${SHELL} /home/laurynas/tmp/libxml/libxml2-2.7.3/missing --run tar
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/laurynas/tmp/libxml/libxml2-2.7.3/missing --run autoconf
AUTOHEADER = ${SHELL} /home/laurynas/tmp/libxml/libxml2-2.7.3/missing --run autoheader
AUTOMAKE = ${SHELL} /home/laurynas/tmp/libxml/libxml2-2.7.3/missing --run automake-1.10
AWK = gawk
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/laurynas/tmp/libxml/libxml2-2.7.3/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MODULE_EXTENSION = .so
...
PYTHON_SITE_PACKAGES = /usr/lib64/python2.5/site-packages
...
Z_CFLAGS = 
Z_LIBS = -lz
abs_builddir = /home/laurynas/tmp/libxml/libxml2-2.7.3
abs_srcdir = /home/laurynas/tmp/libxml/libxml2-2.7.3
abs_top_builddir = /home/laurynas/tmp/libxml/libxml2-2.7.3
abs_top_srcdir = /home/laurynas/tmp/libxml/libxml2-2.7.3
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_F77 = gfortran
am__include = include
...
install_sh = $(SHELL) /home/laurynas/tmp/libxml/libxml2-2.7.3/install-sh
...
libxml2_la_LDFLAGS =   -version-info 9:3:7 -ldl
...
runtest_LDADD = -lpthread  $(LDADDS)
testrecurse_SOURCES = testrecurse.c
testrecurse_LDFLAGS = 
testrecurse_DEPENDENCIES = $(DEPS)
testrecurse_LDADD = -lpthread  $(LDADDS)
...
testThreads_LDADD = -lpthread  $(LDADDS)
